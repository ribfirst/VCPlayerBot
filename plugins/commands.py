...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('✪ Uᴘᴅᴀᴛᴇ', url='https://t.me/teamosmani),
            InlineKeyboardButton('✪ Sᴜᴘᴘᴏʀᴛ', url='https://t.me/osmanigroupbot),
            InlineKeyboardButton('♡︎ Oᴡɴᴇʀ', url='https://t.me/ribajosmani),
           InlineKeyboardButton('➪ Dᴇᴠᴇʟᴏᴘᴇʀ', url='https://t.me/meribaj')                      
        ],
        [
